 ...
 *    to be copied.
 * @param {boolean=} opt_outlinedBlocks Do we want to copy outlined blocks or not [OB]
 *    to be copied.
 * @private
 */
Blockly.copy_ = function(toCopy, opt_outlinedBlocks) {
  if (toCopy.isComment) {
    var xml = toCopy.toXmlWithXY();
  } else {
    var xml = Blockly.Xml.blockToDom(toCopy, false, opt_outlinedBlocks);
 ...
 * @param {boolean=} opt_outlinedBlocks Do we want to duplicate outlined blocks or not [OB]
 * @return {!Blockly.Block} The duplicated blocks
 * @private
 */
Blockly.duplicate_ = function(toDuplicate, opt_outlinedBlocks) {
  // Save the clipboard.
  var clipboardXml = Blockly.clipboardXml_;
  var clipboardSource = Blockly.clipboardSource_;
  
  // Create a duplicate via a copy/paste operation.
  Blockly.copy_(toDuplicate, opt_outlinedBlocks);
  var newDuplicate = toDuplicate.workspace.paste(Blockly.clipboardXml_, opt_outlinedBlocks);
